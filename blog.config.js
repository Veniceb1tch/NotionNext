...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，welcome to 哋它亢 datacon2024',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '哋它亢', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'all for 哋它亢', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'datacon-14803.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '网络黑产分析', // 网站关键词 英文逗号隔开
